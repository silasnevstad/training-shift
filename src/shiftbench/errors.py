...
# Ingestion/manifest/integrity verification errors
E_MANIFEST_MISSING = "E_MANIFEST_MISSING"
E_CHECKSUMS_MISSING = "E_CHECKSUMS_MISSING"
E_REQUIRED_ASSET_MISSING = "E_REQUIRED_ASSET_MISSING"
E_CHECKSUM_RECORD_MISSING = "E_CHECKSUM_RECORD_MISSING"
